...
<%
    ...
    var listItem = ViewBag.Data as List<ModCurrencyEntity>;
%>
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Symbol", "Symbol")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("Exchange rate", "ExchangeRate")%>
                    </th>
                </tr>
            </thead>
            <tfoot>
            ...
            <tbody>
               <%for (int i = 0; listItem != null && i < listItem.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= string.Format("{0:#,##0}", listItem[i].ExchangeRate)%>
                    </td>
                </tr>
                <%} %>
            </tbody>
