...
<%
    ...
    var listAllItem = ViewBag.AllItems as List<ModMenu_DynamicEntity>;
%>
    ...
    <div class="m">
        <table>
            <tr>
                ...
                <td nowrap="nowrap">
                    Loại menu: 
                    <select id="filter_MenuType" onchange="VSWRedirect('Index','0','parent_id')" class="inputbox">
                        <%= Utils.ShowDDLList_SelectTop(ModMenu_TypeService.Instance, string.Empty, string.Empty, model.ModMenuTypeID)%>
                    </select>
                </td>
            </tr>
        </table>
        <table class="adminlist" cellspacing="1">
            ...
            <tbody>
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="left" nowrap="nowrap">
                        <%= listItem[i].getParentName(listAllItem, listItem[i].ParentID)%>
                    </td>
                    <td align="left">
