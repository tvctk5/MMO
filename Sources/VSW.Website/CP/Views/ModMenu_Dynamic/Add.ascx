        ...
        <div class="col width-100">
            <table class="admintable">
                ...
                <tr>
                    ...
                    <td>
                        <input class="text_input" type="text" name="CssIcon" value="<%=item.CssIcon %>" maxlength="50" />
                    </td>
                </tr>
                <tr>
                    <td class="key">
                    ...
                    <td>
                        <textarea class="text_input" style="height:100px;" name="Code"><%=item.Code%></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="key">
