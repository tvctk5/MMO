        ...
        <table>
            <tr>
                ...
                <td nowrap="nowrap">
                    ...
                    Kiểu slide:
                    <select id="SlideType" name="SlideType" onchange="VSWRedirect('Index','0','parent_id')" class="inputbox">
                        <option value="-1">-- Tất cả --</option>
                        <option value="0" <%= (model.SlideType == 0? "selected" : "") %>>Không áp dụng</option>
                        <option value="1"<%= (model.SlideType == 1? "selected" : "") %>>Slide</option>
                    </select>
                </td>
            </tr>
        </table>
