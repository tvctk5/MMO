...
<div id="<%= ViewBag.ModuleId%>">
    <ul class="megamenu skyblue">
     ...
     %>
        ...
        <% if (!string.IsNullOrEmpty(listParent[i].CssIcon))
           {%>
           <i class="<%= listParent[i].CssIcon%>"></i> 
        <%} %>
        <%=listParent[i].Name%></a>
                    ...
                    <% for (int j = 0; j < listChilden.Count; j++)
                       {
                           ...
                           if(page != null)
                           {
                                var getData = listProduct.Where(o=>o.MenuID == page.MenuID);
                                if (getData.Any())
                                    listProduct_sub = getData.ToList();
                                else
                                    listProduct_sub = new List<ModProduct_InfoEntity>();
                           }
                           %>
                           <div class="col-md-2">
                               <div class="h_nav">
								    <h4 class="top"><a href="<%=link %>"><%= listChilden[j].Name %></a></h4>
								    <ul>
