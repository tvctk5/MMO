...
namespace VSW.Lib.Global
{
    public class Utils : VSW.Core.Web.Utils
    {
        ...
        /// <param name="iItemSeletedId"></param>
        /// <returns></returns>
        public static string ShowDDLList_SelectTop(dynamic ServiceInstance, string strWhere, string strOrderBy, int SeletedId = 0)
        {
            string sWhere = string.Empty;
            string s = string.Empty;
            sWhere = @"
            ...
            string sItemSelectedId = SeletedId.ToString();
